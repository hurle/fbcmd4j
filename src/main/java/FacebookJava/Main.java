        ...
        main.SetFacebook();
         ...
         while(true) {
            ...
            switch (option) 
            {
                ...
                case 3:
                    try
                    {
                        ...
                        System.out.println("Se publico el estado correctamente.");
                    }
                    catch(Exception ex)
                    {
			...
			fb.postLink(new URL(link));
                        ...
                        System.out.println("Se publico el link correctamente.");
                    }
                    catch(Exception ex)
                    {
                        logger.info("Error al intentar publicar el link: " + ex.getMessage());
                    }
                    break;
                case 5:
